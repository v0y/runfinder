...
<html lang="${request.locale_name}">
  <head>
    ...
    <link rel="shortcut icon" href="${request.static_url('runfinder:static/pyramid-16x16.png')}">
    ...
    <link href="${request.static_url('runfinder:static/theme.css')}" rel="stylesheet">
  ...
  <body>
    ...
    <div class="starter-template">
      <div class="container">
        <div class="row">
          <div class="col-md-2">
            <img class="logo img-responsive" src="${request.static_url('runfinder:static/pyramid.png')}" alt="pyramid web framework">
          </div>
          <div class="col-md-10">
            <div class="content">
